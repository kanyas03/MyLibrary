  ...
  return (
    <div className="bg-orange-950 h-16 flex justify-between fixed top-0 w-full px-5">
      ...
      <div className="space-x-5 my-auto font-semibold">
        <Link to="/Userhome" className="text-white font-serif hover:text-xl">Home</Link>
        <Link to="/viewbooks" className="text-white font-serif hover:text-xl">Books</Link>
        <Link to="/collections" className="text-white font-serif hover:text-xl">My Collections</Link>
